  ...
  return new Proxy(clientModules, {
    get(
      ...
      return {
        ...
        // manifest when the entry is read. Always using the async form also lets
        // a cached reference move between sync and async modules across builds.
