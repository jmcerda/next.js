...
export type SerializedRuntimeErrorState = Pick<
  OverlayStateWithRouter,
  'errors' | 'routerType'
>
...
function serializeRuntimeErrors(errors: OverlayState['errors']) {
  // Serialize Error properties because they are non-enumerable.
  return errors.map((errorEvent: any) => ({
    ...errorEvent,
